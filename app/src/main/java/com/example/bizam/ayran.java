...
public class ayran extends AppCompatActivity {

    private DatePickerDialog datePickerDialog;
    TextView back1,saveayran;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ayran);
        saveayran=findViewById(R.id.saveayran);
        sharedpref=getSharedPreferences(getString(R.string.preference_file_key),MODE_PRIVATE);
        saveayran.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor editor=sharedpref.edit();
                editor.putBoolean("ayran",true);
                editor.apply();
                Toast.makeText(ayran.this, "Ayran kaydedildi", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ayran.this,Icecekler.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ayran.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(ayran.this,R.color.gri));
