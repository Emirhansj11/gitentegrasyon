    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(su.this,Icecekler.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(su.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(su.this,R.color.gri));
