    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(palamut.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(palamut.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(palamut.this,R.color.gri));
