    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(telefon.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(telefon.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(telefon.this,R.color.gri));
