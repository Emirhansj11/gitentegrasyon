...
public class bezelye extends AppCompatActivity {
    private DatePickerDialog datePickerDialog;
    TextView back1, savebezelye;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bezelye);
        savebezelye=findViewById(R.id.savebezelye);
        sharedpref=getSharedPreferences(getString(R.string.preference_file_key),MODE_PRIVATE);
        savebezelye.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor editor=sharedpref.edit();
                editor.putBoolean("bezelye",true);
                editor.apply();
                Toast.makeText(bezelye.this, "Bezelye kaydedildi", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(bezelye.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(bezelye.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(bezelye.this,R.color.gri));
