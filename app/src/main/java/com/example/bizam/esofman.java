...
public class esofman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esofman);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(esofman.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(esofman.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(esofman.this,R.color.gri));
