...
public class cilek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(cilek.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(cilek.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(cilek.this,R.color.gri));
