...
public class biber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(biber.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(biber.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(biber.this,R.color.gri));
