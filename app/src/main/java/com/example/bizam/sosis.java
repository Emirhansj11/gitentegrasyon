...
public class sosis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(sosis.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(sosis.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(sosis.this,R.color.gri));
