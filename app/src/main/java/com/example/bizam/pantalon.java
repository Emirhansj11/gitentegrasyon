...
public class pantalon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalon);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(pantalon.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(pantalon.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(pantalon.this,R.color.gri));
