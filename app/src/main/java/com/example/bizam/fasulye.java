...
public class fasulye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fasulye);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(fasulye.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(fasulye.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(fasulye.this,R.color.gri));
