...
public class armut extends AppCompatActivity {
    private DatePickerDialog datePickerDialog;
    TextView back1, savearmut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savearmut=findViewById(R.id.savearmut);
        sharedpref=getSharedPreferences(getString(R.string.preference_file_key),MODE_PRIVATE);
        savearmut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor editor=sharedpref.edit();
                boolean armut=sharedpref.getBoolean("armut",false);
                editor.putBoolean("armut",!armut);
                editor.apply();
                if (!armut){
                    Toast.makeText(armut.this, "Armut kaydedildi", Toast.LENGTH_SHORT).show();
                    

                }else{
                    Toast.makeText(armut.this, "Kaydedilenlerden çıkarıldı", Toast.LENGTH_SHORT).show();
                }
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(armut.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(armut.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(armut.this,R.color.gri));
