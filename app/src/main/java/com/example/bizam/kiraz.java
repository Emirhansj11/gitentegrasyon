...
public class kiraz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(kiraz.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(kiraz.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(kiraz.this,R.color.gri));
