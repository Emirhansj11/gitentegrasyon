...
public class pastirma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pastirma);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(pastirma.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(pastirma.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(pastirma.this,R.color.gri));
