...
public class karpuz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(karpuz.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(karpuz.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(karpuz.this,R.color.gri));
