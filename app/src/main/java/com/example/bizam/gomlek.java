...
public class gomlek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gomlek);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(gomlek.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(gomlek.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(gomlek.this,R.color.gri));
