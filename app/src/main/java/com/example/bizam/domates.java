...
public class domates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(domates.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(domates.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(domates.this,R.color.gri));
