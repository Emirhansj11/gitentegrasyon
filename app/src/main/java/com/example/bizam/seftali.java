...
public class seftali extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seftali);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(seftali.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(seftali.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(seftali.this,R.color.gri));
