    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(limon.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(limon.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(limon.this,R.color.gri));
