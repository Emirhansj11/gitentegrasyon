    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(sort.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(sort.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(sort.this,R.color.gri));
