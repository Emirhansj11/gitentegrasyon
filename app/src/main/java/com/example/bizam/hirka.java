...
public class hirka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hirka);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(hirka.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(hirka.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(hirka.this,R.color.gri));
