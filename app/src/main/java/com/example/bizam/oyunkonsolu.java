...
public class oyunkonsolu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oyunkonsolu);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(oyunkonsolu.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(oyunkonsolu.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(oyunkonsolu.this,R.color.gri));
