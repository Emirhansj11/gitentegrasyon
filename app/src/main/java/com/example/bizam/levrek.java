...
public class levrek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_levrek);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(levrek.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(levrek.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(levrek.this,R.color.gri));
