...
public class kiyma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kiyma);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(kiyma.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(kiyma.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(kiyma.this,R.color.gri));
