...
public class bira extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bira);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(bira.this,Icecekler.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(bira.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(bira.this,R.color.gri));
