...
public class mont extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mont);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(mont.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(mont.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(mont.this,R.color.gri));
