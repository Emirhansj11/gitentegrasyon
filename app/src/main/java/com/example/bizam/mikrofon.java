    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mikrofon.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(mikrofon.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(mikrofon.this,R.color.gri));
