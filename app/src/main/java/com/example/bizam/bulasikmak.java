...
public class bulasikmak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bulasikmak);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(bulasikmak.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(bulasikmak.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(bulasikmak.this,R.color.gri));
