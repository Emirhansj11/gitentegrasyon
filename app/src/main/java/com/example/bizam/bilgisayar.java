...
public class bilgisayar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bilgisayar);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(bilgisayar.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(bilgisayar.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(bilgisayar.this,R.color.gri));
