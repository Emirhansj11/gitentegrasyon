...
public class akillisaat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akillisaat);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(akillisaat.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(akillisaat.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(akillisaat.this,R.color.gri));
