    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(tshirt.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(tshirt.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(tshirt.this,R.color.gri));
