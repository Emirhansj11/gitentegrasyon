...
public class salatalik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salatalik);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(salatalik.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(salatalik.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(salatalik.this,R.color.gri));
