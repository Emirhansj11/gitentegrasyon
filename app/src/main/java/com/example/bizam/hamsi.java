    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(hamsi.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(hamsi.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(hamsi.this,R.color.gri));
