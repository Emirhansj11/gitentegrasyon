...
public class ceket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceket);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ceket.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ceket.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(ceket.this,R.color.gri));
