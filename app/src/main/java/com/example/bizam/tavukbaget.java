...
public class tavukbaget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tavukbaget);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(tavukbaget.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(tavukbaget.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(tavukbaget.this,R.color.gri));
