...
public class havuc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(havuc.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(havuc.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(havuc.this,R.color.gri));
