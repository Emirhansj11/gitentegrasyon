...
public class televizyon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_televizyon);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(televizyon.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(televizyon.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(televizyon.this,R.color.gri));
