...
public class sweatshirt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(sweatshirt.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(sweatshirt.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(sweatshirt.this,R.color.gri));
