...
public class elbise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elbise);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(elbise.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(elbise.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(elbise.this,R.color.gri));
