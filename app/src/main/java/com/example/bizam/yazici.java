...
public class yazici extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(yazici.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(yazici.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(yazici.this,R.color.gri));
