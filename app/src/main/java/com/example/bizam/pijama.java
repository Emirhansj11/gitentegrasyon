...
public class pijama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pijama);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(pijama.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(pijama.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(pijama.this,R.color.gri));
