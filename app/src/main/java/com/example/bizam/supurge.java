...
public class supurge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supurge);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(supurge.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(supurge.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(supurge.this,R.color.gri));
