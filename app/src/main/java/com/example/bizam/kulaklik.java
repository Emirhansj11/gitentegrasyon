...
public class kulaklik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kulaklik);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(kulaklik.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(kulaklik.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(kulaklik.this,R.color.gri));
