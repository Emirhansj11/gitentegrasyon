...
public class camasirmak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camasirmak);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(camasirmak.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(camasirmak.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(camasirmak.this,R.color.gri));
