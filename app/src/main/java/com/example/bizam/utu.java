    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(utu.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(utu.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(utu.this,R.color.gri));
