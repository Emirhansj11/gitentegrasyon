    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(firin.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(firin.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(firin.this,R.color.gri));
