    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(salam.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(salam.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(salam.this,R.color.gri));
