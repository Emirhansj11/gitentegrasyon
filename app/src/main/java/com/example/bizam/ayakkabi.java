...
public class ayakkabi extends AppCompatActivity {
    private DatePickerDialog datePickerDialog;
    TextView back1,saveayakkabi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ayakkabi);
        saveayakkabi=findViewById(R.id.saveayakkabi);
        sharedpref=getSharedPreferences(getString(R.string.preference_file_key),MODE_PRIVATE);
        saveayakkabi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor editor=sharedpref.edit();
                boolean ayakkabi=sharedpref.getBoolean("ayakkabi",false);
                editor.putBoolean("ayakkabi",!ayakkabi);
                editor.apply();
               if (!ayakkabi){
                   Toast.makeText(ayakkabi.this, "Ayakkabı kaydedildi", Toast.LENGTH_SHORT).show();
               }else{
                   Toast.makeText(ayakkabi.this, "Kaydedilenlerden çıkarıldı", Toast.LENGTH_SHORT).show();
               }
            }
        });
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ayakkabi.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ayakkabi.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(ayakkabi.this,R.color.gri));
