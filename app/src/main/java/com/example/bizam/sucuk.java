...
public class sucuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sucuk);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(sucuk.this,EtUrunleri.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(sucuk.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(sucuk.this,R.color.gri));
