    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(buzdolabi.this,Elektronik.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(buzdolabi.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(buzdolabi.this,R.color.gri));
