    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(kola.this,Icecekler.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(kola.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(kola.this,R.color.gri));
