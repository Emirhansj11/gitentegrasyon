    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(brokoli.this,MeyveSebze.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(brokoli.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(brokoli.this,R.color.gri));
