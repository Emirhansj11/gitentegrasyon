...
public class etek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etek);

        back1=(TextView)findViewById(R.id.back);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(etek.this,Giyim.class);
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(etek.this, R.color.gri));
        getWindow().setNavigationBarColor(ContextCompat.getColor(etek.this,R.color.gri));
